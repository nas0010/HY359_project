...
public class UpdateLibrarian extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       JSON_Converter converter = new JSON_Converter();
        ...
        EditLibrarianTable su = new EditLibrarianTable();
        ...
        try {
            su.updateLibrarian(username, jo.getString("email"),
                    ...
                    jo.getString("address"), jo.getString("telephone"),  jo.getString("info"),jo.getString("library_name"));
