...
public class LoginLibrarian extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session.getAttribute("username") == null) {
            out.println("LibrarianLogin.html");

        } else {
            //userlogged in
            out.println("Librarian.html");
        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            Librarian user = librarian.databaseToLibrarian(userN.getUsername(), userN.getPassword());
            ...
            if (user == null) {
                ...
                session.setAttribute("library_id", user.getLibrary_id());
