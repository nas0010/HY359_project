...
public class DeleteStudent extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            EditStudentsTable table = new EditStudentsTable();
            
            table.deleteStudent(username);
            ...
            for (Student doc:table.databaseToStudents()) {
    ...
    protected void deleteS(String username) throws SQLException, ClassNotFoundException {
